...
import aboutImg from '../assets/red-cloud-mine.webp';

function About() {
  return (
  <div className="py-16 bg-white mb-20 mt-20">  
    <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
        <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
          <div className="md:5/12 lg:w-5/12">
          <img className='items-center campicon' src={aboutImg} alt="camp" />
          </div>
          <div className="md:7/12 lg:w-6/12">
            <h2 className="text-2xl text-gray-900 font-bold md:text-4xl">Discover your next adventure!</h2>
